...
export async function GET(req: NextRequest) {
  ...
  const fetchUrl = `https://apis.data.go.kr/B551011/TarRlteTarService1/getTarRlteTarList?baseYm=${baseYm}&areaCd=${areaCd}&signguCd=${signguCd}&numOfRows=10&pageNo=1&MobileOS=ETC&MobileApp=AppTest&_type=json&serviceKey=${encodedKey}`;
